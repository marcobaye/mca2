...
class convertor(object):
	...
	def output(self):
		...
		items_defaults = [str(item.default) for item in self.items.get_defd_and_refd()]
		...
		print '; var offsets:'
		print '\t; items:'
		for item in self.items.get_defd_and_refd():
		...
		items_descs = [item.description for item in self.items.get_defd_and_refd()]

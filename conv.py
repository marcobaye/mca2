...
class convertor(object):
	...
	def output(self):
		...
		items_defaults = [str(item.default) for item in self.items.values()]
		...
		items_names = [item.game_name for item in self.items.values()]
		print 'item_name_lo'
		if len(items_defaults):
			print '\t!tx',
			print '<' + ', <'.join(items_names)
		print 'item_name_hi'
		if len(items_defaults):
			print '\t!tx',
			print '>' + ', >'.join(items_names)
		items_descs = [item.description for item in self.items.values()]
		print 'item_desc_lo'
		if len(items_defaults):
			print '\t!tx',
			print '<' + ', <'.join(items_descs)
		print 'item_desc_hi'
		if len(items_defaults):
			print '\t!tx',
			print '>' + ', >'.join(items_descs)
